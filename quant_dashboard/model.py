diff --git a//dev/null b/quant_dashboard/model.py
index 0000000000000000000000000000000000000000..6a4040ef9fe706d32f892f1b150c07e49832aed8 100644
--- a//dev/null
+++ b/quant_dashboard/model.py
@@ -0,0 +1,27 @@
+import pandas as pd
